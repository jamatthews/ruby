...
static inline void RARY_RMALLOC_SET(VALUE ary);
static inline void RARY_RMALLOC_UNSET(VALUE ary);
...
static inline void
RARY_RMALLOC_SET(VALUE ary)
{
#if USE_RMALLOC
    FL_SET_RAW(ary, RARRAY_RMALLOC_FLAG);
#endif
}

static inline void
RARY_RMALLOC_UNSET(VALUE ary)
{
#if USE_RMALLOC
    FL_UNSET_RAW(ary, RARRAY_RMALLOC_FLAG);
#endif
}
